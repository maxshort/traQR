...
/**
 * Not ours - Modified from
 * http://techdiary.peterbecker.de/2009/02/defending-against-xss-attacks-in.html
 */
public class WrappingReader extends Reader {
	...
	public int read(char[] cbuf, int off, int len) throws IOException {
		...
		Logger.getLogger(getClass().getName())
				.trace(String.format("Copied %d characters, now at position %d", pos - oldPos, pos));
		return pos - oldPos;
	}
